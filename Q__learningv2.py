...
from Q_learning_method import init_function, q_max_function, reward_function


class Q_learningv2:
    def __init__(self, init_func=init_function, nb_action=81, alpha=0, load_checkpoint=False):
        self.action_list = []
    ...
    def update_charging_pos(self, charging_pos):
        self.action_list = charging_pos
